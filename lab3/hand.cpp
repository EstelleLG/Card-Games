...
//This cpp implements a hand class.
...
/*
returns a string type of a hand.
*/
...
/*
This function returns a corresponding card object given the position index
If the index is greater than the hand's size, throw an exception
*/
Card hand::operator [] (size_t index) {
	if ((int)index >= this->size()) {   
		...
		return this->hand_.at(index);
	}
}

/*
This function removes the card that a given position.
Throw an exception if supplied index is invalid.
Else use erase method.
*/
int hand::remove_card(size_t index) {
	if ((int)index >= this->size()) {                                    
		...
		this->hand_.erase(this->hand_.begin() + index);
		return success;
	}
}

/*
This function returns the size of a hand.
*/
...
/*
This function returns the private member hand_ of this hand.
*/
...
/*
This function compares two hand.
*/
...
/*
This function find a rankPoint for a hand.
*/
rankPoint findRank(const vector<Card> &hands) {
...
/*
This function returns a string of a card's suit.
*/
string getHandSuit(Card a) {
...
/*
This function returns a string of a card's rank.
*/
string getHandRank(Card b){
