...
enum command_line_arguments { program_name, first_argument, shuffle_argument, output_file };
enum command_line_length { one_arguments = 2, two_arguments = 3};
enum command_line_return { no_argument = 1, one_argument_shuffle, two_invalid_arguments, more_than_two_arguments, less_than_three_arguments};
